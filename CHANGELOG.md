...
- **Safe Backup Restore**: Sanitized autogenerated primary keys (`id = 0`) on restored exercise attempts and added full persistence for `dailyPractices` and all user preferences.
