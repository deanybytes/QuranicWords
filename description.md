# 📱 Google Play Store Descriptions & Metadata

> This file contains all types of Google Play Store descriptions (Titles, Short, Long, Detailed/Flagship, ASO, Release Notes, and Multi-language localizations) strictly following Google Play character limits. See also [PLAY_STORE_DESCRIPTION.md](PLAY_STORE_DESCRIPTION.md).

---

## ⏱️ Quick Summary of Character Limits
...
## 🏷️ 1. App Titles (Character Limit: Max 30)

| Option | Title Text | Chars | Notes |
|---|---|---|---|
| **Option 1 (Recommended)** | `QuranicWords: Learn Arabic` | **26 / 30** | Best overall balance of brand + intent |
| **Option 2** | `QuranicWords - Quran Arabic` | **27 / 30** | High keyword volume |
| **Option 3** | `QuranicWords: Quran Words` | **25 / 30** | Clear, focused |
| **Option 4** | `QuranicWords: Learn Quran` | **25 / 30** | Action-oriented |
| **Option 5** | `Quranic Words - Quran Arabic` | **28 / 30** | Spaced brand query |

---

## 📝 2. Short Descriptions (Character Limit: Max 80)

| Option | Text | Chars | Tone |
|---|---|---|---|
...
## 📖 3. Full Descriptions (Character Limit: Max 4,000)

### 🌟 Option A: Flagship Master Description (Recommended)
*Character Count: ~3,480 / 4,000*
...
### ⚡ Option B: Concise Feature-Focused Description
*Character Count: ~2,250 / 4,000*
...
### 🔍 Option C: ASO & Search-Optimized Description
*Character Count: ~3,350 / 4,000*
...
## 🌐 5. Localized Descriptions (Key Languages)
...
- **Title (<=30)**: `QuranicWords: Kosakata Quran` (28)
- **Short (<=80)**: `Kuasai 4.700+ kata Al-Qur'an berdasarkan frekuensi. 100% offline & tanpa iklan.` (79)
- **Full**:
```text
...
### 🇹🇷 Turkish (Türkçe)
- **Title (<=30)**: `QuranicWords: Kuran Arapçası` (28)
- **Short (<=80)**: `4.700+ Kuran kelimesini sıklık sırasıyla öğrenin. %100 çevrimdışı ve reklamsız.` (78)
- **Full**:
```text
...
### 🇫🇷 French (Français)
- **Title (<=30)**: `QuranicWords: Arabe du Coran` (28)
- **Short (<=80)**: `Apprenez 4 700+ mots du Coran par fréquence. 100% hors ligne et sans pub.` (74)
- **Full**:
```text
